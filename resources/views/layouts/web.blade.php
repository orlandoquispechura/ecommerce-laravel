...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="galio_cliente/assets/img/favicon.ico" type="image/x-icon" />

    <!-- Bootstrap CSS -->
    {!! Html::style('galio_cliente/assets/css/bootstrap.min.css') !!}
    <!-- Font-Awesome CSS -->
    {!! Html::style('galio_cliente/assets/css/font-awesome.min.css') !!}
    <!-- helper css -->
    {!! Html::style('galio_cliente/assets/css/helper.min.css') !!}
    <!-- Plugins CSS -->
    {!! Html::style('galio_cliente/assets/css/plugins.css') !!}
    <!-- Main Style CSS -->
    {!! Html::style('galio_cliente/assets/css/style.css') !!}
    {!! Html::style('galio_cliente/assets/css/skin-default.css') !!}
    @yield('styles')
</head>
...
<body>
        ...
        <div class="color-switcher-inner">
            ...
            <div class="switcher-panel-item">
                ...
                <ul class="nav flex-wrap colors">
                    <li class="default active" data-color="default" data-toggle="tooltip" data-placement="top"
                        title="Red"></li>
                    <li class="green" data-color="green" data-toggle="tooltip" data-placement="top"
                        title="Green"></li>
                    ...
                    <li class="sky-blue" data-color="sky-blue" data-toggle="tooltip" data-placement="top"
                        title="Sky-Blue"></li>
                    <li class="orange" data-color="orange" data-toggle="tooltip" data-placement="top"
                        title="Orange"></li>
                    <li class="violet" data-color="violet" data-toggle="tooltip" data-placement="top"
                        title="Violet"></li>
                </ul>
            </div>
            ...
            <div class="switcher-panel-item bg">
                ...
                <ul class="nav flex-wrap bgbody-style bg-pattern">
                    <li><img src="galio_cliente/assets/img/bg-panel/bg-pettern/1.png" alt="Pettern"></li>
                    <li><img src="galio_cliente/assets/img/bg-panel/bg-pettern/2.png" alt="Pettern"></li>
                    <li><img src="galio_cliente/assets/img/bg-panel/bg-pettern/3.png" alt="Pettern"></li>
                    <li><img src="galio_cliente/assets/img/bg-panel/bg-pettern/4.png" alt="Pettern"></li>
                    <li><img src="galio_cliente/assets/img/bg-panel/bg-pettern/5.png" alt="Pettern"></li>
                    <li><img src="galio_cliente/assets/img/bg-panel/bg-pettern/6.png" alt="Pettern"></li>
                </ul>
            </div>
            ...
            <div class="switcher-panel-item bg">
                ...
                <ul class="nav flex-wrap bgbody-style bg-img">
                    <li><img src="galio_cliente/assets/img/bg-panel/bg-img/01.jpg" alt="Images"></li>
                    <li><img src="galio_cliente/assets/img/bg-panel/bg-img/02.jpg" alt="Images"></li>
                    <li><img src="galio_cliente/assets/img/bg-panel/bg-img/03.jpg" alt="Images"></li>
                    <li><img src="galio_cliente/assets/img/bg-panel/bg-img/04.jpg" alt="Images"></li>
                    <li><img src="galio_cliente/assets/img/bg-panel/bg-img/05.jpg" alt="Images"></li>
                    <li><img src="galio_cliente/assets/img/bg-panel/bg-img/06.jpg" alt="Images"></li>
                </ul>
            </div>
        </div>
    </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-3">
                            <div class="brand-logo">
                                <a href="index-2.html">
                                    <img src="galio_cliente/assets/img/logo/logo.png" alt="brand logo">
                                </a>
                            </div>
                        </div> <!-- end logo area -->
                        <div class="col-lg-9">
                                ...
                                <div class="header-middle-block">
                                    ...
                                    <div class="header-mini-cart">
                                        ...
                                        <ul class="cart-list">
                                            <li>
                                                <div class="cart-img">
                                                    <a href="product-details.html"><img src="galio_cliente/assets/img/cart/cart-1.jpg"
                                                            alt=""></a>
                                                </div>
                                                <div class="cart-info">
                                            ...
                                            <li>
                                                <div class="cart-img">
                                                    <a href="product-details.html"><img src="galio_cliente/assets/img/cart/cart-2.jpg"
                                                            alt=""></a>
                                                </div>
                                                <div class="cart-info">
                ...
                <div class="container">
                    <div class="footer-bottom-wrap">
                        ...
                        <div class="payment-method-img">
                            <img src="galio_cliente/assets/img/payment.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-lg-5">
                                <div class="product-large-slider slick-arrow-style_2 mb-20">
                                    <div class="pro-large-img">
                                        <img src="galio_cliente/assets/img/product/product-details-img1.jpg" alt="" />
                                    </div>
                                    <div class="pro-large-img">
                                        <img src="galio_cliente/assets/img/product/product-details-img2.jpg" alt="" />
                                    </div>
                                    <div class="pro-large-img">
                                        <img src="galio_cliente/assets/img/product/product-details-img3.jpg" alt="" />
                                    </div>
                                    <div class="pro-large-img">
                                        <img src="galio_cliente/assets/img/product/product-details-img4.jpg" alt="" />
                                    </div>
                                    <div class="pro-large-img">
                                        <img src="galio_cliente/assets/img/product/product-details-img5.jpg" alt="" />
                                    </div>
                                </div>
                                <div class="pro-nav slick-padding2 slick-arrow-style_2">
                                    <div class="pro-nav-thumb"><img src="galio_cliente/assets/img/product/product-details-img1.jpg"
                                            alt="" /></div>
                                    <div class="pro-nav-thumb"><img src="galio_cliente/assets/img/product/product-details-img2.jpg"
                                            alt="" /></div>
                                    <div class="pro-nav-thumb"><img src="galio_cliente/assets/img/product/product-details-img3.jpg"
                                            alt="" /></div>
                                    <div class="pro-nav-thumb"><img src="galio_cliente/assets/img/product/product-details-img4.jpg"
                                            alt="" /></div>
                                    <div class="pro-nav-thumb"><img src="galio_cliente/assets/img/product/product-details-img5.jpg"
                                            alt="" /></div>
                                </div>
                            </div>
                            <div class="col-lg-7">
    ...
    {!! Html::script('galio_cliente/assets/js/vendor/modernizr-3.6.0.min.js') !!}
    <!-- Jquery Min Js -->
    {!! Html::script('galio_cliente/assets/js/vendor/jquery-3.3.1.min.js') !!}
    <!-- Popper Min Js -->
    {!! Html::script('galio_cliente/assets/js/vendor/popper.min.js') !!}
    <!-- Bootstrap Min Js -->
    {!! Html::script('galio_cliente/assets/js/vendor/bootstrap.min.js') !!}
    <!-- Plugins Js-->
    {!! Html::script('galio_cliente/assets/js/plugins.js') !!}
    <!-- Ajax Mail Js -->
    {!! Html::script('galio_cliente/assets/js/ajax-mail.js') !!}
    <!-- Active Js -->
    {!! Html::script('galio_cliente/assets/js/main.js') !!}
    <!-- Switcher JS [Please Remove this when Choose your Final Projct] -->
    {!! Html::script('galio_cliente/assets/js/switcher.js') !!}
    @yield('scripts')
</body>
