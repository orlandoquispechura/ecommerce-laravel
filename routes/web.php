...
Route::get('/productos', function() {
    return view('web_cliente.producto_right');
    // return redirect()->route('login');
});
Route::get('/detalles', function() {
    return view('web_cliente.producto_detalle');
    // return redirect()->route('login');
});
Route::get('/cuenta', function() {
    return view('web_cliente.my_cuenta');
    // return redirect()->route('login');
});

Route::get('/login_registro', function() {
    return view('web_cliente.login_registro');
    // return redirect()->route('login');
});

Route::get('/contacto', function() {
    return view('web_cliente.contacto');
    // return redirect()->route('login');
});
Route::get('/carrito', function() {
    return view('web_cliente.carrito');
    // return redirect()->route('login');
});
Route::get('/blog', function() {
    return view('web_cliente.blog');
    // return redirect()->route('login');
});
Route::get('/blog_detalle', function() {
    return view('web_cliente.blog_detalles');
    // return redirect()->route('login');
});

Route::get('/about', function() {
    return view('web_cliente.about');
    // return redirect()->route('login');
});
Route::get('/pagar', function() {
    return view('web_cliente.checkout');
    // return redirect()->route('login');
});
